...
![Empty Workspace](../static/img/miranumIDE_empty-workspace.png)
...
![Create new Project](../static/img/miranumIDE_create-new-project.png)
...
![Generate new File](../static/img/miranumIDE_generate-new-file.png)
